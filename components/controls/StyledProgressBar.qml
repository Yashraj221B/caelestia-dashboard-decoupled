    ...
    Component {
        ...
        Item {
            Line {
                ...
                implicitWidth: parent.width - progress.implicitWidth - Tokens.spacing.extraSmall
            }
            ...
            Line {
                ...
                implicitWidth: parent.width * root.visualPosition
        ...
        Item {
            ...
            Instantiator {
                ...
                delegate: Line {
                    ...
                    readonly property point bounds: root.toBounds(
                        modelData.startFraction,
                        modelData.endFraction,
                        modelData.gapSize / 2
                    )
